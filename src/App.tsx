          ...
          <div className="hidden md:flex space-x-6">
            {settings.phones[0] && (
              <span className="flex items-center gap-1">
                {settings.phones[0].includes("263773937863") ? (
                  ...
                  <a href={`tel:${settings.phones[0]}`} className="flex items-center gap-1 hover:text-teal-300 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-12 border-b border-slate-800 items-start">
            ...
            <div className="md:col-span-4 space-y-2 font-sans text-xs">
              ...
              <div className="text-slate-500 flex flex-wrap items-center gap-x-2 gap-y-1">
                <span>Tel:</span>
                {settings.phones.map((phone, i) => (
          ...
          <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
            ...
            >
              ...
              <form onSubmit={handleAdminLogin} className="space-y-4">
                ...
                {loginStep === "password" ? (
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      <label className="text-xs text-slate-500 font-semibold uppercase">2FA Authenticator Code</label>
                      <span className="text-[10px] text-teal-600 bg-teal-50 px-2 py-0.5 rounded" title="Add this to Google Authenticator">Secret: JBSWY3DPEHPK3PXP</span>
                    </div>
                    <input
                      type="text"
                      value={adminCode}
                      ...
                      className="w-full bg-slate-50 border border-slate-200 text-slate-800 px-4 py-3 rounded text-sm focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500 text-center font-mono tracking-widest text-lg"
                      required
                      maxLength={6}
                    />
                  </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-teal-900 text-white font-bold py-3 rounded uppercase tracking-wider text-xs hover:bg-teal-800 transition-colors shadow-md flex justify-center items-center"
                >
                  {loginStep === "password" ? "Continue" : "Verify & Sign In"}
                </button>
